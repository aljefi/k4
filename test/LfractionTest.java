...
public class LfractionTest {
    ...
    @Test(timeout = 1000)
    public void testPow() {
        Lfraction p1 = new Lfraction(100, 999);
        Lfraction p11 = p1.pow(0);
        assertEquals("Error!", new Lfraction(1, 1), p11);

        Lfraction p2 = new Lfraction(2, 3);
        Lfraction p22 = p2.pow(1);
        assertEquals("Error!", new Lfraction(2, 3), p22);

        Lfraction p3 = new Lfraction(2, 3);
        Lfraction p333 = p3.inverse();
        Lfraction p33 = p3.pow(-1);
        assertEquals("Error!", p333, p33);

        Lfraction p4 = new Lfraction(2, 3);
        Lfraction p44 = p4.pow(3);
        assertEquals("Error!", new Lfraction(8, 27), p44);

        Lfraction p5 = new Lfraction(2, 3);
        Lfraction p55 = p5.pow(-3);
        assertEquals("Error!", new Lfraction(27, 8), p55);
    }
